...
import { html_blue_wrapper } from './gulp/tasks/html_blue-wrapper.js'
...
function watcher() {
  ...
  gulp.watch(path.watch.html, html_blue_wrapper)
...
// Основные задачи
const mainTasks = gulp.series(fonts, gulp.parallel(copy, html_blue, html_blue_wrapper, html_green, html_main, html_white, scss, js, images))
